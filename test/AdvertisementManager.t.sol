...
contract AdvertisementManagerTest is Test {
    ...
    function test_CreateAdvertisement() public {
        ...
        emit NewAdvertisement(0, "https://test.com", "https://image.com/test.png", price, user1, address(0));

        adManager.createAdvertisement{value: price}("https://test.com", "https://image.com/test.png", address(0));
    ...
    function test_CreateAdvertisement_WithReferrer() public {
        ...
        adManager.createAdvertisement{value: adManager.getNextAdPrice()}(
            "https://test1.com", "https://image1.com", address(0)
        );
        ...
        "https://test2.com", "https://image2.com", user1);
    ...
    function test_Revert_CreateAdvertisement_InsufficientPayment() public {
        ...
        adManager.createAdvertisement{value: price - 1}("https://test.com", "https://image.com", address(0));
    }
    ...
    function test_Revert_CreateAdvertisement_EmptyLink() public {
        ...
        adManager.createAdvertisement{value: adManager.getNextAdPrice()}("", "https://image.com", address(0));
    }
    ...
    function test_CreateAdvertisement_PriceIncreases() public {
        ...
        vm.prank(user1);
        adManager.createAdvertisement{value: price1}("https://test1.com", "https://image1.com", address(0));
    ...
    function test_RecordEngagement() public {
        vm.prank(user1);
        adManager.createAdvertisement{value: adManager.getNextAdPrice()}(
            "https://test.com", "https://image.com", address(0)
        );
    ...
    function test_Revert_Refer_AlreadyReferred() public {
        ...
        vm.startPrank(user2);
        adManager.createAdvertisement{value: adManager.getNextAdPrice()}(
            "https://test2.com", "https://image2.com", address(0)
        );
        adManager.refer(user1);
    ...
    function test_AddAchievement() public {
        adManager.addAchievement("First Steps", "Create your first ad", 1, 100e18);

        assertEq(adManager.getTotalAchievements(), 1);
    }

    function test_UnlockAchievement() public {
        adManager.addAchievement("Engager", "Engage with 10 ads", 10, 100e18);
    ...
    function test_Withdraw() public {
        vm.prank(user1);
        uint256 price = adManager.getNextAdPrice();
        adManager.createAdvertisement{value: price}("https://test.com", "https://image.com", address(0));
    ...
    function test_GetCurrentAd() public {
        vm.prank(user1);
        adManager.createAdvertisement{value: adManager.getNextAdPrice()}(
            "https://test.com", "https://image.com/test.png", address(0)
        );

        (string memory link, string memory imageUrl,, address advertiser,, bool isActive,) = adManager.getCurrentAd();
    ...
    function test_GetActiveAds_WithPagination() public {
        for (uint256 i = 0; i < 5; i++) {
            vm.prank(user1);
            adManager.createAdvertisement{value: adManager.getNextAdPrice()}(
                string(abi.encodePacked("https://test", vm.toString(i), ".com")), "https://image.com", address(0)
            );
        }
    ...
    function test_GetUserStats() public {
        ...
        (uint256 adsCreated, uint256 adsEngaged, uint256 timesChief, uint256 referralsCount,,,) =
    ...
    function testFuzz_CreateAdvertisement(uint256 payment) public {
        ...
        vm.prank(user1);
        adManager.createAdvertisement{value: payment}("https://test.com", "https://image.com", address(0));
    ...
    function _setUserLevel(address user, uint256 level) internal {
        ...
        vm.store(address(adManager), levelSlot, bytes32(level));
    }
...
contract MaliciousReentrancy {
    ...
    function attack() external {
        target.createAdvertisement{value: target.getNextAdPrice()}(
            "https://malicious.com", "https://image.com", address(0)
        );
    }
