...
contract DeployAdvertisementManager is Script {
    ...
    function _saveDeployment(uint256 chainId, address adManager, address adToken) internal {
        string memory json = string(abi.encodePacked(
            ...
            '  "network": "', networkConfigs[chainId].name, '",\n',
            '  "AdvertisementManager": "', vm.toString(adManager), '",\n',
            '  "AdToken": "', vm.toString(adToken), '",\n',
    ...
    function _saveAllDeployments() internal {
        ...
        for (uint256 i = 0; i < deployments.length; i++) {
            ...
            json = string(abi.encodePacked(
                ...
                '    "AdvertisementManager": "', vm.toString(d.adManager), '",\n',
                '    "AdToken": "', vm.toString(d.adToken), '"\n',
                '  }',
